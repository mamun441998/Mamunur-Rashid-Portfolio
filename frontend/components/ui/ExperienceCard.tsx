    ...
    <div className="relative pl-8 md:pl-10 group">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 mb-4">
          ...
          {/* Date Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[var(--panel-2)] border border-[var(--bd)] text-xs font-mono text-[var(--txt-2)] self-start md:self-auto">
        ...
        {/* Description */}
        <p className="text-[var(--txt-2)] text-sm md:text-base leading-relaxed font-inter mt-4 whitespace-pre-line">
